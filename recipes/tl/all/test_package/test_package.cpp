...
std::string append_int(std::string s, int i) { return s + std::to_string(i); }
...
int main() {
    ...
    static_assert(
        std::is_same<tl::make_index_range<3, 5>, tl::index_sequence<3, 4, 5, 6, 7>>::value,
