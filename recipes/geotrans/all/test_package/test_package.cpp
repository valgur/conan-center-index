...
void convertGeodeticEllipsoidToGeocentric(
    MSP::CCS::CoordinateConversionService &ccsGeodeticEllipsoidToGeocentric, double lat, double lon,
    double height, double &x, double &y, double &z) {
    MSP::CCS::Accuracy sourceAccuracy;
    MSP::CCS::Accuracy targetAccuracy;
    MSP::CCS::GeodeticCoordinates sourceCoordinates(MSP::CCS::CoordinateType::geodetic, lon, lat,
                                                    height);
...
void convertGeocentricToGeodeticEllipsoid(
    MSP::CCS::CoordinateConversionService &ccsGeodeticEllipsoidToGeocentric, double x, double y,
    double z, double &lat, double &lon, double &height) {
    MSP::CCS::Accuracy geocentricAccuracy;
    MSP::CCS::Accuracy geodeticAccuracy;
    MSP::CCS::CartesianCoordinates geocentricCoordinates(MSP::CCS::CoordinateType::geocentric, x, y,
                                                         z);
    ...
    ccsGeodeticEllipsoidToGeocentric.convertTargetToSource(
        &geocentricCoordinates, &geocentricAccuracy, geodeticCoordinates, geodeticAccuracy);
...
void convertGeocentricToGeodeticMslEgm96(
    MSP::CCS::CoordinateConversionService &ccsGeocentricToGeodeticMslEgm96, double x, double y,
    double z, double &lat, double &lon, double &height) {
    MSP::CCS::Accuracy sourceAccuracy;
    MSP::CCS::Accuracy targetAccuracy;
    MSP::CCS::CartesianCoordinates sourceCoordinates(MSP::CCS::CoordinateType::geocentric, x, y, z);
    MSP::CCS::GeodeticCoordinates targetCoordinates(MSP::CCS::CoordinateType::geodetic, lon, lat,
                                                    height);
...
void convertMslEgm96ToEllipsoidHeight(
    MSP::CCS::CoordinateConversionService &ccsMslEgm96ToEllipsoidHeight, double lat, double lon,
    double mslHeight, double &ellipsoidHeight) {
    MSP::CCS::Accuracy sourceAccuracy;
    MSP::CCS::Accuracy targetAccuracy;
    MSP::CCS::GeodeticCoordinates sourceCoordinates(MSP::CCS::CoordinateType::geodetic, lon, lat,
                                                    mslHeight);
...
void convertEllipsoidHeightToMslEgm96(
    MSP::CCS::CoordinateConversionService &ccsEllipsoidHeightToMslEgm96, double lat, double lon,
    double ellipsoidHeight, double &mslHeight) {
    MSP::CCS::Accuracy sourceAccuracy;
    MSP::CCS::Accuracy targetAccuracy;
    ...
    ccsEllipsoidHeightToMslEgm96.convertSourceToTarget(&sourceCoordinates, &sourceAccuracy,
                                                       targetCoordinates, targetAccuracy);
 ...
 **/
void convertGeocentricToUtm(MSP::CCS::CoordinateConversionService &ccsGeocentricToUtm, double x,
    ...
    ccsGeocentricToUtm.convertSourceToTarget(&sourceCoordinates, &sourceAccuracy, targetCoordinates,
                                             targetAccuracy);
 ...
 **/
std::string convertGeocentricToMgrs(MSP::CCS::CoordinateConversionService &ccsGeocentricToMgrs,
...
int main(int argc, char **argv) {
    ...
    //
    MSP::CCS::GeodeticParameters ellipsoidParameters(MSP::CCS::CoordinateType::geodetic,
    ...
    MSP::CCS::GeodeticParameters mslEgm96Parameters(MSP::CCS::CoordinateType::geodetic,
                                                    MSP::CCS::HeightType::EGM96FifteenMinBilinear);

    MSP::CCS::UTMParameters utmParameters(MSP::CCS::CoordinateType::universalTransverseMercator, 1,
                                          0);
    ...
    MSP::CCS::CoordinateConversionService ccsMslEgm96ToEllipsoidHeight(WGE, &mslEgm96Parameters,
                                                                       WGE, &ellipsoidParameters);
    MSP::CCS::CoordinateConversionService ccsEllipsoidHeightToMslEgm96(WGE, &ellipsoidParameters,
                                                                       WGE, &mslEgm96Parameters);

    MSP::CCS::CoordinateConversionService ccsGeocentricToUtm(WGE, &geocentricParameters, WGE,
                                                             &utmParameters);
    MSP::CCS::CoordinateConversionService ccsGeocentricToMgrs(WGE, &geocentricParameters, WGE,
                                                              &mgrsParameters);
    ...
    try {
        ...
        convertGeodeticEllipsoidToGeocentric(ccsGeodeticEllipsoidToGeocentric, lat, lon, height, x,
                                             y, z);
        ...
        // conversion
        convertGeocentricToGeodeticEllipsoid(ccsGeodeticEllipsoidToGeocentric, x, y, z, lat, lon,
                                             height);
        ...
        convertGeocentricToGeodeticMslEgm96(ccsGeocentricToGeodeticMslEgm96, x, y, z, lat, lon,
                                            mslHeight);
        ...
        //
        convertMslEgm96ToEllipsoidHeight(ccsMslEgm96ToEllipsoidHeight, lat, lon, mslHeight, height);

        std::cout << "Convert Geodetic (MSL EMG96 15M Height) To Geodetic (Ellipsoid Height)"
                  << std::endl
                  << std::endl
                  << "Lat (radians): " << lat << std::endl
                  << "Lon (radians): " << lon << std::endl
        ...
        //
        convertEllipsoidHeightToMslEgm96(ccsEllipsoidHeightToMslEgm96, lat, lon, height, mslHeight);

        std::cout << "Revert Geodetic (Ellipsoid Height) To Geodetic (MSL EGM96 15M) Height"
                  << std::endl
                  << std::endl
                  << "Lat (radians): " << lat << std::endl
                  << "Lon (radians): " << lon << std::endl
        ...
        convertGeocentricToUtm(ccsGeocentricToUtm, x, y, z, zone, hemi, easting, northing);
        ...
        mgrsString = convertGeocentricToMgrs(ccsGeocentricToMgrs, x, y, z, precision);
        ...
        std::cerr << "ERROR: Unexpected exception encountered - " << e.what() << std::endl;
    }
