...
void *HelloWorldPubSubType::createData() { return reinterpret_cast<void *>(new HelloWorld()); }

void HelloWorldPubSubType::deleteData(void *data) { delete (reinterpret_cast<HelloWorld *>(data)); }
...
bool HelloWorldPubSubType::getKey(void *data, InstanceHandle_t *handle, bool force_md5) {
    ...
    eprosima::fastcdr::Cdr ser(
        fastbuffer, eprosima::fastcdr::Cdr::BIG_ENDIANNESS); // Object that serializes the data.
