...
class RaylibConan(ConanFile):
    ...
    def generate(self):
        ...
        if self.settings.os == "Android":
            ...
            tc.variables["OPENGL_VERSION"] = (
                "OFF" if not self.options.opengl_version else self.options.opengl_version
            )
    ...
    def package(self):
        ...
        self._create_cmake_module_alias_targets(
            os.path.join(self.package_folder, self._module_file_rel_path), {"raylib": "raylib::raylib"}
        )
