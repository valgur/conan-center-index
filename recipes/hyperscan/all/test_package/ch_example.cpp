...
static std::tuple<std::shared_ptr<ch_database_t>, std::shared_ptr<ch_compile_error_t>, ch_error_t>
compile(const char *pattern) {
    ...
    return std::tuple<std::shared_ptr<ch_database_t>, std::shared_ptr<ch_compile_error_t>,
                      ch_error_t>(std::shared_ptr<ch_database_t>(db, ch_free_database),
...
static std::pair<std::shared_ptr<ch_scratch_t>, ch_error_t> alloc_scratch(ch_database_t &db) {
    ...
    return std::pair<std::shared_ptr<ch_scratch_t>, ch_error_t>(
        std::shared_ptr<ch_scratch_t>(scratch, ch_free_scratch), result);
}

static ch_error_t scan(ch_database_t &db, ch_scratch_t &scratch, const char *data,
                       ch_match_event_handler handler, void *context) {
