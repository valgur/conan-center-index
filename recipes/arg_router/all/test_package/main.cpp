...
int main(int argc, char *argv[]) {
    ar::root(arp::validation::default_validator,
             ar::help("help"_S, "h"_S, "Display this help and exit"_S,
                      arp::program_name_t{"just-cats"_S}, arp::program_intro_t{"Prints cats!"_S},
             ...
             ar::flag("แมว"_S, //
                      "แมวไทย"_S, arp::router{[](bool) { std::cout << "แมว" << std::endl; }}),
             ar::flag("кіт"_S, //
                      "український кіт"_S,
...
int main(int argc, char *argv[]) {
    ar::root(arp::validation::default_validator,
             ar::help(S_("help"){}, S_('h'){}, S_("Display this help and exit"){},
                      arp::program_name<S_("just-cats")>, arp::program_intro<S_("Prints cats!")>,
             ...
             ar::flag(S_("🐱"){}, //
                      ...
                      arp::router{[](bool) { std::cout << "🐱" << std::endl; }}),
             ar::flag(S_("แมว"){}, //
                      S_("แมวไทย"){}, arp::router{[](bool) { std::cout << "แมว" << std::endl; }}),
             ar::flag(S_("кіт"){}, //
                      S_("український кіт"){},
                      arp::router{[](bool) { std::cout << "кіт" << std::endl; }}))
        .parse(argc, argv);
