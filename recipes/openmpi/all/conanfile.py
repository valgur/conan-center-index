...
class OpenMPIConan(ConanFile):
    ...
    def package_info(self):
        ...
        # https://github.com/open-mpi/ompi/blob/385c7916/opal/mca/installdirs/env/opal_installdirs_env.c#L52-L68
        self.runenv.define_path("OPAL_PREFIX", self.package_folder)
        self.runenv.define_path("OPAL_EXEC_PREFIX", self.package_folder)
        self.runenv.define_path("OPAL_BINDIR", os.path.join(self.package_folder, "bin"))
        self.runenv.define_path("OPAL_SBINDIR", os.path.join(self.package_folder, "bin"))
        self.runenv.define_path("OPAL_DATAROOTDIR", self.package_folder)
        self.runenv.define_path("OPAL_DATADIR", self.package_folder)
        self.runenv.define_path("OPAL_LIBDIR", os.path.join(self.package_folder, "lib"))
        self.runenv.define_path("OPAL_INCLUDEDIR", os.path.join(self.package_folder, "include"))
        self.runenv.define_path("OPAL_PKGDATADIR", os.path.join(self.package_folder, "res"))
