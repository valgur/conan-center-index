...
class ProfilerCallback final : public physx::PxProfilerCallback {
  public:
    ...
    virtual void *zoneStart(const char *eventName, bool detached, uint64_t contextId) { return 0; }
...
int main() {
    ...
    nv::cloth::InitializeNvCloth(&defaultAllocatorCallback, &defaultErrorCallback,
                                 nv::cloth::GetNvClothAssertHandler(), &defaultProfilerCallback);
