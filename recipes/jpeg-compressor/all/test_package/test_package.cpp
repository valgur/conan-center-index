...
int main(int argc, const char *argv[]) {
    ...
    uint8_t *pImage_data = jpgd::decompress_jpeg_image_from_file(pSrc_filename, &width, &height,
    ...
    if (!jpge::compress_image_to_jpeg_file_in_memory(pBuf, buf_size, width, height, req_comps,
                                                     pImage_data)) {
