...
class GdalConan(ConanFile):
    ...
    def _configure_cmake(self):
        ...
        if self.options.with_geos:
            ...
            cmake.definitions["TARGET_FOR_GEOS"] = self.dependencies["geos"].cpp_info.get_property(
                "cmake_target_name"
            )
        else:
        ...
        if self.options.with_gif:
            ...
            cmake.definitions["TARGET_FOR_GIF"] = self.dependencies["giflib"].cpp_info.get_property(
                "cmake_target_name"
            )
        else:
        ...
        if self.options.with_gta:
            ...
            cmake.definitions["TARGET_FOR_GTA"] = self.dependencies["libgta"].cpp_info.get_property(
                "cmake_target_name"
            )
        else:
        ...
        if self.options.with_hdf4:
            ...
            cmake.definitions["TARGET_FOR_HDF4"] = self.dependencies["hdf4"].cpp_info.get_property(
                "cmake_target_name"
            )
        else:
        ...
        if self.options.with_hdf5:
            ...
            cmake.definitions["TARGET_FOR_HDF5"] = self.dependencies["hdf5"].cpp_info.get_property(
                "cmake_target_name"
            )
        else:
        ...
        if self.options.with_kea:
            ...
            cmake.definitions["TARGET_FOR_KEA"] = self.dependencies["kealib"].cpp_info.get_property(
                "cmake_target_name"
            )
        else:
        ...
        if self.options.with_lz4:
            ...
            cmake.definitions["TARGET_FOR_LZ4"] = self.dependencies["lz4"].cpp_info.get_property(
                "cmake_target_name"
            )
        else:
        ...
        if self.options.with_mongocxx:
            ...
            cmake.definitions["TARGET_FOR_MONGOCXX"] = self.dependencies[
                "mongo-cxx-driver"
        ...
        if self.options.with_odbc:
            ...
            cmake.definitions["TARGET_FOR_ODBC"] = self.dependencies["odbc"].cpp_info.get_property(
                "cmake_target_name"
            )
        else:
        ...
        if self.options.with_pcre:
            ...
            cmake.definitions["TARGET_FOR_PCRE"] = self.dependencies["pcre"].cpp_info.get_property(
                "cmake_target_name"
            )
        else:
        ...
        if self.options.with_png:
            ...
            cmake.definitions["TARGET_FOR_PNG"] = self.dependencies["libpng"].cpp_info.get_property(
                "cmake_target_name"
            )
        else:
        ...
        if self.options.with_proj:
            ...
            cmake.definitions["TARGET_FOR_PROJ"] = self.dependencies["proj"].cpp_info.get_property(
                "cmake_target_name"
            )
        else:
        ...
        if self.options.with_zlib:
            ...
            cmake.definitions["TARGET_FOR_ZLIB"] = self.dependencies["zlib"].cpp_info.get_property(
                "cmake_target_name"
            )
        else:
        ...
        if self.options.with_zstd:
            ...
            cmake.definitions["TARGET_FOR_ZSTD"] = self.dependencies["zstd"].cpp_info.get_property(
                "cmake_target_name"
            )
        else:
