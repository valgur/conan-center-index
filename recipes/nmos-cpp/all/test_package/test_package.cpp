...
int main(int argc, char *argv[]) {
    ...
    auto node_server =
        nmos::experimental::make_node_server(node_model, node_implementation, log_model, gate);
    nmos::insert_resource(node_model.node_resources,
                          nmos::make_node(nmos::make_id(), node_model.settings));
