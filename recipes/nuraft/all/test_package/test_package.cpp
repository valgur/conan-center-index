...
class echo_state_machine : public nuraft::state_machine {
  ...
  public:
    ...
    nuraft::ptr<nuraft::buffer> pre_commit(const nuraft::ulong, nuraft::buffer &) override {
        return nullptr;
    }
    ...
    int read_snapshot_data(nuraft::snapshot &, const nuraft::ulong, nuraft::buffer &) override {
        return 0;
    }
