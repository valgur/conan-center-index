...
class NvplSparseConan(ConanFile):
    name = "nvpl_sparse"
    ...
    def build(self):
        self._utils.download_cuda_package(self, "nvpl_sparse", platform_id="linux-sbsa")
    ...
    def package_info(self):
        self.cpp_info.set_property("cmake_file_name", "nvpl_sparse")
        self.cpp_info.set_property("cmake_target_name", "nvpl_sparse")
        self.cpp_info.set_property("cmake_target_aliases", ["nvpl::sparse", "nvpl::sparse_shared"])
        self.cpp_info.libs = ["nvpl_sparse"]
