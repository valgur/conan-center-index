...
class RuyConan(ConanFile):
    ...
    def validate(self):
        ...
        if not minimum_version:
            ...
            raise ConanInvalidConfiguration(
                "Build requires support for C++14. Minimum version for {} is {}".format(
                    str(self.settings.compiler), minimum_version
                )
            )
    ...
    def _patch_sources(self):
        ...
        replace_in_file(
            self,
            os.path.join(self.source_folder, "cmake", "ruy_cc_library.cmake"),
