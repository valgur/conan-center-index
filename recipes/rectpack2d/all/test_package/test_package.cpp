...
int main() {
    ...
    /*
            ...
            You can also pass a "static_empty_spaces<10000>" which will allocate 10000 spaces on the
       stack, possibly improving performance.
    */
    ...
    */
    ...
    /*
            ...
            AND the next candidate bin size differs from the last successful one by *less* then
       discard_step.
       ...
       - E.g. with discard_step = -4, the algoritm will behave as if you passed discard_step = 1,
            ...
            Since discard_step = 0 does not make sense, the algoritm will automatically treat this
       case as if it were passed a discard_step = 1.
    ...
    */
    ...
    /*
            ...
            Every subsequent call to the packer library will only read the widths and heights that
       we now specify, and always overwrite the x and y coordinates with calculated results.
    */
...

    {
        ...
        const auto result_size = find_best_packing<spaces_type>(
            ...
            my_custom_order_1, my_custom_order_2);
    ...
    {
        /* Example 4: Manually perform insertions. This way you can try your own best-bin finding
         * logic. */
