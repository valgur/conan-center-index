...
class PipeWireConan(ConanFile):
    ...
    def generate(self):
        ...
        tc.project_options["udevrulesdir"] = os.path.join("udev", "rules.d")
        tc.project_options["vulkan"] = feature("with_vulkan")
        tc.project_options["x11"] = feature("with_x11")
        tc.project_options["x11-xfixes"] = feature("with_x11")
        tc.generate()
    ...
    def package_info(self):
        ...
        self.runenv_info.define("SPA_PLUGIN_DIR", os.path.join(self.package_folder, "lib", f"libspa-{libspa_api_version}"))
        self.runenv_info.define("SPA_DATA_DIR", os.path.join(self.package_folder, "share", f"libspa-{libspa_api_version}"))
        ...
        self.cpp_info.components["libpipewire"].set_property("pkg_config_custom_content", f"plugindir=${{libdir}}/spa-{libspa_api_version}")
        if self.options.with_libalsa:
