...
#pragma comment (lib, "tk"  STRINGIZE2(TCL_MAJOR_VERSION) STRINGIZE2(TCL_MINOR_VERSION) ".lib")""",
    ...
    def package(self):
        cmake = CMake(self)
        cmake.install()
        copy(self, "LICENSE_LGPL_21.txt", src=self.source_folder, dst=os.path.join(self.package_folder, "licenses"))
        copy(self, "OCCT_LGPL_EXCEPTION.txt", src=self.source_folder, dst=os.path.join(self.package_folder, "licenses"))
