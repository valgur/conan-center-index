...
if(CMAKE_FIND_PACKAGE_NAME STREQUAL "CUDAToolkit")
...
if(CMAKE_FIND_PACKAGE_NAME STREQUAL "CUDA")
    ...
    list(APPEND CUDA_INCLUDE_DIRS "${CUDAToolkit_INCLUDE_DIRS}")
    list(APPEND CUDA_LIBRARIES "${CUDAToolkit_LIBRARIES}")
    ...
    foreach(npp_lib npp nppc nppi nppial nppicc nppicom nppidei nppif nppig nppim nppist nppisu nppitc npps)
        if(TARGET npp::${npp_lib})
            set(CUDA_${npp_lib}_LIBRARY npp::${npp_lib})
        endif()
    endforeach()
    ...
    if(TARGET CUDA::OpenCL)
        set(CUDA_OpenCL_LIBRARY CUDA::OpenCL)
    endif()
endif()
