...
int main() {
    ...
    static_assert(h5pp::type::sfinae::has_data<std::vector<double>>() and
                  "h5pp ompile time type-checker failed. Could not properly detect class member "
                  "data. Check that you are using a supported compiler!");
    ...
    // Generate dummy data
    std::vector<cplx> vectorComplexWrite = {
        {-0.191154, 0.326211}, {0.964728, -0.712335}, {-0.0351791, -0.10264}, {0.177544, 0.99999}};
