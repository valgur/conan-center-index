...
int main() {
    ...
    ldns_rr_list *rrsigs = rrset_from_str(
        ...
        "sZ24Gr6kcWVUMU+pFsoEiW+R7TeE2f3g9EcuIq3Rh+aA38ZslHIv41fFjN9KdfQOdivHlgZ+"
        "d6cvhJfXczaHHYRTpLdvkz6s/mbJ7z+NnvpJdQa7g1qWXD6f2rHyC0TjyV15divsK+aogSs/"
        "xXuRZfUlPxqe5Lrwtaxp0r471GU=");
    ldns_rr_list *dnskeys =
        rrset_from_str("nlnetlabs.nl. 3205 IN DNSKEY 256 3 8 "
                       "AwEAAdR7XR95OaAN9Rz7TbtPalQ9guQk7zfxTHYNKhsiwTZA9z+"
                       "F16nD0VeBlk7dNik3ETpT2GLAwr9sntG898JwurCDe353wHPvjZtMCdiTVp3cRCrjuCEvoFpmZN"
                       "N82H0gaH/4v8mkv/QBDAkDSncYjz/FqHKAeYy3cMcjY6RyVweh");
