...
class ProtobufCConan(ConanFile):
    ...
    options = {"fPIC": [True, False], "with_proto3": [True, False], "with_protoc": [True, False]}
    default_options = {"fPIC": True, "with_proto3": True, "with_protoc": True}
    ...
    def build_requirements(self):
        ...
        if conan_version.major >= 2:
            self.tool_requires("protobuf/3.21.12", visible=True)
        else:
    ...
    def package_info(self):
        ...
        self.cpp_info.set_property(
            "cmake_build_modules", [os.path.join(self._cmake_install_base_path, "protobuf-c.cmake")]
        )
