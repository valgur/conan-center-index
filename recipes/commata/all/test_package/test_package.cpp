...
template <class Ch> class test_collector {
  ...
  public:
    ...
    void start_record(const Ch * /*record_begin*/) { field_values_->emplace_back(); }

    void update(const Ch *first, const Ch *last) { field_value_.append(first, last); }
