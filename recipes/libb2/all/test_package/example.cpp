...
int main() {
    ...
    const std::string expected_hash =
        "aff48ebab1a2b9947c811248b52a157738159af3a2599993188fd3977d20c58e67a98636717e13b62b95183ff7"
        "79abdb2dcad039599f5e54588d83a7b2fc3827";
    std::array<unsigned char, BLAKE2B_OUTBYTES> output;
    int result; // Zero if OK

    result =
        blake2(output.data(), output.size(), input.data(), input.size(), key.data(), key.size());
